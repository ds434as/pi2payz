  ...
  return (
    <section className="flex h-screen font-fira overflow-hidden">
      ...
      <section className="flex-1 w-full h-screen overflow-y-auto bg-gray-50">
        ...
        <div className="p-6">
          <h1 className="text-xl font-semibold mb-4">Payout Report</h1>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Total Cashout</th>
                    </tr>
                  </thead>
                  <tbody className="bg-white divide-y divide-gray-200">
                    {filteredAccounts.map((account) => (
                      <tr key={account._id}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{account.total_payoutno}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">৳{account.total_cashout}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
