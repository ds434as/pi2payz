...
const Rejectedcashin = () => {
  ...
  useEffect(() => {
    const fetchTransactions = async () => {
      try {
        const response = await axios.get(`${base_url}/auth/cash-out/pending`);
      ...
      <div className="flex pt-[10vh] h-[90vh]">
        ...
        >
          <div className="bg-white py-4 px-2">
            <h2 className="text-2xl font-bold text-gray-800 mb-6">Pending Cash Out Transactions</h2>
