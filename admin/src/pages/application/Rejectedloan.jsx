...
const Rejectedloan = () => {
  ...
  useEffect(() => {
    const fetchLoans = async () => {
      try {
        const response = await axios.get(`${base_url}/api/admin/rejected-loan-applications`);
      ...
      <div className="flex pt-[10vh] h-[90vh]">
        ...
        >
          <div className="bg-white px-2 py-4 rounded-lg shadow-sm">
            <h2 className="text-2xl font-bold text-gray-800 mb-6">Rejected Loan Applications</h2>
